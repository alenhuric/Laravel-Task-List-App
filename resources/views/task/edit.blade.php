                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form  method="POST" name="form-create-task" id="myForm" enctype="multipart/form-data" >
                        ...
                        <div class="col-md-10 offset-md-2">
                            ...
                            <!-- first name -->
                            <div class="form-group row m-b-17 {{ $errors->has('name') ? 'has-error' : ''}}">
                        ...
                        <center>
                                <button type="submit" class="btn btn-primary submit" id="submit" style="width:15em">Update Task</button>     
                        </center>
                     </form>
                </div>
            </div>
